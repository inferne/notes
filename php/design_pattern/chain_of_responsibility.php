...
abstract class Logger
{
    ...
    public function logMessage($level, $message)
    {
        ...
        if($this->_nextLogger){
            $this->_nextLogger->logMessage($level, $message);
        }
    }
 ...
 */
$console = new ConsoleLogger(Logger::CONSOLE);
$error = new ErrorLogger(Logger::ERROR);
$info = new InfoLogger(Logger::INFO);
$console->setNextLogger($error);
$error->setNextLogger($info);

$console->logMessage(Logger::INFO, "This is an information.");
$console->logMessage(Logger::CONSOLE, "This is an debug information.");
$console->logMessage(Logger::ERROR, "This is an error information.");
